                ...
                if topk_cap > 0:
                    ...
                    if base_top5_hits is not None and base_top5_hits.numel() == hits_post.numel():
                        ...
                        print(
                            ...
                            f" | delta_hits_sum={diff_hits:.0f} | changed_candidates={changed_candidates}"
    ...
    for epoch in range(config.epochs):
        ...
        if tune_early_stop_enabled:
            ...
            if improvement:
                ...
                patience_text = f"{tune_stale_epochs}/{tune_patience}" if tune_patience else "inf"
...
def _run_training_pipeline():
    ...
    parser.add_argument('--diag_dump_dir', type=str, default="./outputs/diagnosis", help='Optional: export raw similarity snapshots per epoch for offline diagnosis')
    ...
    parser.add_argument('--split_dir', type=str, default=None, help='Directory containing per-fold split JSONs (e.g., outer_sub-*.json); if set, runs all folds')
    ...
    for split in fold_splits:
        ...
        for sub in subjects_to_train:
            ...
            try:
                ...
                print("KeyboardInterrupt detected. Clearing memory before exit...")
                clear_memory()
                raise
            finally:
...
def main():
    ...
    try:
        ...
        print(f"\n Total runtime ({status_label}): {format_duration_hm(elapsed)}")
